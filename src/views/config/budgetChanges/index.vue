<template>
  ...
  <BudgetChangesModal @refresh="refreshData" ref="continueCarryoverModalRef" />
  <BudgetChangesBatchModal @refresh="refreshData" ref="continueCarryoverBatchModalRef" />
  <HelpModal ref="helpModalRef" />
</template>

<script setup lang="ts" name="/config/budgetChanges/index">
...
import BudgetChangesBatchModal from '@/views/config/budgetChanges/components/BudgetChangesBatchModal.vue'
import BudgetChangesModal from '@/views/config/budgetChanges/components/BudgetChangesModal.vue'
...
const continueCarryoverModalRef = ref<InstanceType<typeof BudgetChangesModal>>()
const continueCarryoverBatchModalRef = ref<InstanceType<typeof BudgetChangesBatchModal>>()
