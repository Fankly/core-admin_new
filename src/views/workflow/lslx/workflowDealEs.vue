...
import { getTableDataForEs, getDynamicColumnForEs } from '@/api/lslxJsc/index'
import { mbzesFinishWf, mbzesReject } from '@/api/workflow/lslx/index'
...
const handlerClickBtn = (val: any) => {
  ...
  const api = val == 'pass' ? mbzesFinishWf : mbzesReject
