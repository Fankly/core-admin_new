...
<script setup lang="ts" name="/deptDataVersion/digitalization/xxhxg/submit">
...
import { tableForm } from '@/views/deptDataVersion/digitalization/hooks'

const { yjdwList, protableCurdRef, userDialogRef, tableRef, pageInfo, submitbtn, tableColumns, clickBtn, pageType, getPage, getRoleHandle, userInfo, versionId, nd  } = handleTable('12')
