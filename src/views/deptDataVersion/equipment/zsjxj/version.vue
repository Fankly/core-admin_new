...
<script setup lang="ts" name="/deptDataVersion/equipment/zsjxj/version">
...
const { userInfo, protableCurdRef, yjdwList, versionId, userDialogRef, tableRef, modalRef, pageInfo, btnList, tableColumns, clickBtn, pageType, getPage, getRoleHandle, showModal, title, nd } = handleTable('15')
