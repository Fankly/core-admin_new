...
<script setup lang="ts" name="/deptDataVersion/equipment/sdxl/submit">
...
const { yjdwList, protableCurdRef, userDialogRef, tableRef, pageInfo, submitbtn, tableColumns, clickBtn, pageType, getPage, getRoleHandle, userInfo, versionId, nd  } = handleTable('14')
