...
<script setup lang="ts" name="/deptDataVersion/disPatchCenter/qt/version">
...
import { tableForm } from '@/views/deptDataVersion/disPatchCenter/hooks'

const { userInfo, protableCurdRef, yjdwList, versionId, userDialogRef, tableRef, modalRef, pageInfo, btnList, tableColumns, clickBtn, pageType, getPage, getRoleHandle, showModal, title, nd } = handleTable('8')
