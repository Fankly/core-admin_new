...
<script setup lang="ts" name="/deptDataVersion/disPatchCenter/qt/submit">
...
const { yjdwList, protableCurdRef, userDialogRef, tableRef, pageInfo, submitbtn, tableColumns, clickBtn, pageType, getPage, getRoleHandle, userInfo, versionId, nd  } = handleTable('8')
