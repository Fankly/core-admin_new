...
<script setup lang="ts" name="/deptDataVersion/logistics/qt/submit">
...
const { yjdwList, protableCurdRef, userDialogRef, tableRef, pageInfo, submitbtn, tableColumns, clickBtn, pageType, getPage, getRoleHandle, userInfo, versionId, nd  } = handleTable('11')
