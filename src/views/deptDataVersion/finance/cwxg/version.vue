...
<script setup lang="ts" name="/deptDataVersion/finance/cwxg/version">
...
import { tableForm } from '@/views/deptDataVersion/finance/hooks'

const { userInfo, protableCurdRef, yjdwList, versionId, userDialogRef, tableRef, modalRef, pageInfo, btnList, tableColumns, clickBtn, pageType, getPage, getRoleHandle, showModal, title, nd } = handleTable('4')
