...
<script setup lang="ts" name="/deptDataVersion/technology/zlyf/version">
...
import { tableForm } from '@/views/deptDataVersion/technology/hooks'

const { userInfo, protableCurdRef, yjdwList, versionId, userDialogRef, tableRef, modalRef, pageInfo, btnList, tableColumns, clickBtn, pageType, getPage, getRoleHandle, showModal, title, nd } = handleTable('1')
