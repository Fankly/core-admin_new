...
import { getDnrhszjPage, saveZj, YnrhsxmPage, YnrhszjPage } from '@/api/service/IhhsMeeting/approval/cityLhhsMeeting'
...
const expertColumns = reactive<any[]>([
  ...
  },
  {
    ...
    label: '一级单位',
    width: '180',
    search: { el: 'select', props: { onChange: changeEjdwEnum, clearable: true }, order: 1 },
...
const acceptParams = async (params: ModalProps) => {
  ...
  const yjdw = modalProps.value.dwId || ''
