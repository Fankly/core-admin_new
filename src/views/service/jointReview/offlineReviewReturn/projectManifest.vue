<template>
  <div class="container" v-if="isShowPage">
    ...
    <el-row :gutter="10" class="main-layout" :class="{ 'main-layout--left-collapsed': isLeftCollapsed }">
      <!-- 左侧：项目列表 -->
      <el-col id="offline-review-return-project-list" :span="6" class="left-column">
      ...
      <el-tooltip :content="isLeftCollapsed ? '展开项目列表' : '收起项目列表'" placement="right" effect="light">
        <button
          ...
          aria-controls="offline-review-return-project-list"
...
import { offlineReview } from '@/views/service/jointReview/offlineReviewReturn/hooks/psy'
...
const hasButtonPermission = (permission: string) => checkPermission(buttonPermissions.value, permission)

const handleOpinionChange = (target: 'development' | 'finance', opinion: string) => {
