  ...
  <div class="process-step" @click="showDropdown" @mouseleave="hideDropdown">
    <div class="step-content">
      <div class="step-header">
        <div class="step-icon">
          <img
            v-if="step.icon === '1'"
            src="@/assets/images/zl/wendangxinxi.svg"
            :alt="step.appName"
          />
          <img
            v-if="step.icon === '2'"
            src="@/assets/images/zl/iconfront-.svg"
            :alt="step.appName"
          />
          <img
            v-if="step.icon === '3'"
            src="@/assets/images/zl/xingzhuangjiehe.svg"
            :alt="step.appName"
          />
          <img
            v-if="step.icon === '4'"
            src="@/assets/images/zl/wendangxiazai.svg"
            :alt="step.appName"
          />
        </div>
      </div>
    ...
    >
      <div class="dropdown-menu">
        <div
          v-for="action in step.menus"
          :key="action.id"
          class="dropdown-item"
          :class="{ disabled: !action.hasPermision }"
...
.process-step:hover .step-icon img {
  filter: brightness(0) saturate(100%) invert(39%) sepia(65%) saturate(1052%) hue-rotate(138deg)
