  ...
  <div class="main" v-if="isShowPage" v-loading="loading">
    <div class="opeartion">
      <div class="left">
        <el-button
          ...
          type="primary"
          size="mini"
          v-debounce="[editHandle, `click`, 300]"
          >修 改</el-button
        >
        <el-button
          v-permission="'DELETE'"
          ...
          type="primary"
          size="mini"
          v-debounce="[deleteHandle, `click`, 300]"
          >删 除</el-button
        >
        <el-button
          v-permission="'SUBMIT'"
          type="primary"
          size="mini"
          v-debounce="[submitWorkflowHandle, `click`, 300]"
          >提 交</el-button
        >
        <el-button
          v-permission="'EXPORT'"
          ...
          type="primary"
          size="mini"
          v-debounce="[exportHandle, `click`, 300]"
          >导 出</el-button
        >
        <el-button
          ...
          type="primary"
          size="mini"
          v-debounce="[processHandle, `click`, 300]"
          >流程履历</el-button
        >
      </div>
      <div class="right">
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="spanComp">
            <div class="operation" style="text-align: right; margin-bottom: 10px">
              ...
              <el-button plain type="primary" size="mini" @click="searchDataHandle"
                >查 询</el-button
              >
              <el-button plain type="primary" size="mini" @click="settingHandle"
                >高级设置</el-button
              >
            </div>
          </el-col>
    ...
    <div class="table">
      <vxe-grid
        ...
        height="100%"
        v-bind="gridOptions"
        @cell-click="({row,column}:any)=>cellClickHandle(row,column,'1')"
      ></vxe-grid>
    </div>
    <div class="bottom">
      <el-pagination
    ...
    <DynamicReports
      ...
      @show-modal="showHandle"
      ref="dynamicReportsRef"
      :title="title"
    />
  </div>
...
<script lang="ts">
export default {
  name: '/service/xq/ZlModification'
}
</script>
...
const spanComp = computed(() =>
  linkLength.value % 4 === 0
    ? 24
    : linkLength.value % 4 === 1
    ? 18
    : linkLength.value % 4 === 2
    ? 12
    : linkLength.value % 4 === 3
    ? 6
    : 24
)
...
const cellClickHandle = async (row: any, column: any, flag: string) => {
