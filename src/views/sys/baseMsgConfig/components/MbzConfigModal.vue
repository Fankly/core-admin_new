  ...
  >
    <template #default>
      <el-form :rules="formRules" ref="formRef" :model="formData">
        <el-form-item label="是否目标值总控节点" prop="mbzZkjd">
          <el-select style="width: 100%" v-model="formData.mbzZkjd">
...
<script setup lang="ts" name="MbzConfigModal">
import { reactive, ref } from 'vue'
import { ElMessage } from 'element-plus'
import VXETable from 'vxe-table'
import { mbzConfig } from '@/api/sys/proCategory'
