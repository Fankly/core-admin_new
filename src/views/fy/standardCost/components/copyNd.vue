<template>
  <vxe-modal height="200" width="20%" v-bind="$attrs" :destroy-on-close="true" :loading="loading" @show="showHandle" @close="closeHandle" :title="modalTitle" v-model="showModal" show-zoom resize position="center">
    <el-form>
...
import { copyData } from "@/api/fy/searchConfig";
...
const saveHandle = async () => {
  let res = await copyData(formData);
  if (res.success) {
