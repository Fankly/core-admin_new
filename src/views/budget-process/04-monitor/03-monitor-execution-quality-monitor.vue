<template>
  <div class="ExecutionQuality">
    ...
    <QualityMonitoring v-if="this.temShow === 'box-1'"></QualityMonitoring>
...
import QualityMonitoring from "../../../components/quality-monitoring/QualityMonitoring.vue";
import ReserveEstablishment from "../../../components/quality-monitoring/ReserveEstablishment.vue";
import Bidding from "../../../components/quality-monitoring/Bidding.vue";
...
export default defineComponent({
  ...
  setup() {
    const dataOne = ref(["南京", "苏州", "无锡", "常州", "镇江", "扬州", "泰州", "南通"]);
    const dataTwo = ref(["大中型基建", "小型基建", "工业建筑", "商业建筑", "住宅建筑", "其他"]);
    return reactive({
      temShow: "",
      dataOne,
      dataTwo
