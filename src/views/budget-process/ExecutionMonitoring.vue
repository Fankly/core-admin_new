<script lang="ts">
export default {
  name: '/budget-process/ExecutionMonitoring'
}
</script>
  ...
  <div v-loading="loading" class="container" v-if="isShowPage">
    <div class="operate">
      <div class="operate-button">
        <el-button v-permission="'LIST'" @click="detailedQueryHandle" size="mini" type="success">
          项目清单</el-button
        >
      </div>
      <div class="operate-filter">
        ...
        >
          <el-tooltip content="列设置" placement="top">
            <span style="cursor: pointer; font-size: 18px" class="el-icon-s-operation"></span>
          </el-tooltip>
          <template #dropdown>
            <el-dropdown-menu>
