  ...
  <header class="app-header">
    <div class="header-content">
      <div class="title-area">
        ...
        <h1 class="header-title">预算项目全过程监控中心-连云港</h1>
      </div>
      ...
      <div class="filter-controls">
        ...
        <div class="filter-item">
          ...
          <el-select v-model="filters.xmlx" style="width: 80px">
...
import { XMDL_TYPES, MUNICIPAL_DEPTS, IMPLEMENTATION_DEPTS } from '@/views/lyg/overviewMap/data/overviewData'
...
const getDataList = async (params: any) => {
  const codes: any = await getSsbmCodesList({ ...params, codes: ['LYG_ZBXM_ZCBLX_COM', 'GKBM'] })
  if (!codes.success) return ElMessage.error(codes.msg)
  XMDL_TYPES.value = codes.data[0].codes
  IMPLEMENTATION_DEPTS.value = codes.data[1].codes
