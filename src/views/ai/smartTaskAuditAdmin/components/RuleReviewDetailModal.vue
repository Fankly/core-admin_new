          ...
          <div class="review-card__header">
            <span class="title">
              ...
              <span class="review-card__title-text">
                ...
                <span class="review-card__title-hint">审核过程与预览文档对照</span>
              </span>
            </span>
          </div>
          <div class="review-process-columns">
            <section class="review-process-column review-process-column--reasoning" aria-label="审核过程">
              ...
              <div v-else class="review-process-column__content review-process-column__empty">暂无审核过程</div>
            </section>
...
import type { AuditReviewTablePayload, RuleReviewDetailItem } from './auditDetailHelpers'
...
/* 审核过程内容区：面板背景负责层级，这里只负责内边距，随左右两栏等高拉伸 */
