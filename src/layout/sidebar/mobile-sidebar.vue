<template>
  <el-drawer v-model="state.show" :append-to-body="false" size="230" :withHeader="false" direction="ltr" custom-class="rr-setting-wrap">
    <div class="rr-header-ctx-logo rr-header-ctx-logo-mobile">
      <logo :logoUrl="logoUrl" logoName="项目过程管控平台"></logo>
    </div>
