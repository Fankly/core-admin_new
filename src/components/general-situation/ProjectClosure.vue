            ...
            <el-form style="margin-left: 20px">
              <el-row>
                <el-col>
                  <el-form-item>
                    <label slot="label">
                      <span style="font-size: 16px">关闭项目数量</span>
                    </label>
                    <div>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(12)` }}
                      </span>
                      <span style="font-size: 14px; margin-left: 10px">万个</span>
                    </div>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item>
                    <label slot="label">
                      <span style="font-size: 16px">项目关闭率</span>
                    </label>
                    <div>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(4.6)` }}
              ...
              <el-row>
                <el-col>
                  <el-form-item>
                    <label slot="label">
                      <span style="font-size: 16px">已关闭完成项目率</span>
                    </label>
                    <div>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(25.6)` }}
