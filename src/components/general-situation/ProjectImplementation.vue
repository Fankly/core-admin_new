      ...
      <div class="leftBox">
        <figure>
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="项目开工情况" name="first">
                ...
                <el-form style="margin-left: 20px">
                  <el-row>
                    <el-col>
                      <el-form-item>
                        <label slot="label">
                          <span style="font-size: 16px">已开工项目金额：</span>
                        </label>
                        <div>
                  ...
                  <el-row>
                    <el-col>
                      <el-form-item>
                        <label slot="label">
                          <span style="font-size: 16px">已开工项目数量：</span>
                        </label>
                        <div>
                          <span style="font-size: 14px; color: blue; margin-left: 30px">
                            {{ `(12)` }}
                          </span>
                          <span style="font-size: 14px; margin-left: 10px">个</span>
                        </div>
                      </el-form-item>
                    </el-col>
                  </el-row>
            ...
            <el-tab-pane label="项目竣工情况" name="second">
              <div style="display: flex">
                <v-chart style="width: 30%; height: 300px" :option="leftEch" :loadingOptions="barLoadingOptions" :theme="theme" :autoresize="autoResize" />
