      ...
      <div class="leftBox">
        <figure>
          <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <el-form>
                <el-row>
                  <el-col>
                    <el-form-item>
                      <label slot="label">
                        <span style="font-size: 16px">年度物资需求提报金额</span>
                      </label>
                ...
                <el-row>
                  <el-col>
                    <el-form-item>
                      <label slot="label">
                        <span style="font-size: 16px">年度物资需求中标金额</span>
                      </label>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(4445)` }}
                      </span>
            ...
            <el-tab-pane label="服务类" name="second">
              <el-form>
                <el-row>
                  <el-col>
                    <el-form-item>
                      <label slot="label">
                        <span style="font-size: 16px">年度服务需求提报金额</span>
                      </label>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(4445)` }}
                      </span>
                ...
                <el-row>
                  <el-col>
                    <el-form-item>
                      <label slot="label">
                        <span style="font-size: 16px">年度服务需求中标金额</span>
                      </label>
                      <span style="font-size: 14px; color: blue; margin-left: 30px">
                        {{ `(4445)` }}
                      </span>
