  ...
  <div class="dynamic-upload-table" v-loading="loading">
    <div class="upload-header">
      ...
      <div class="upload-action" v-if="showDelete">
        <el-button :disabled="loading" type="primary" @click="insertEvent()"> 上传文件 </el-button>
      </div>
    </div>
    ...
    >
      ...
      <vxe-column v-if="showActions" title="操作" width="180" align="center">
        <template #default="{ row }">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const getInsertEvent = async (records: any[], fjId: string) => {
      ...
      try {
        const tableData = await baseService.post(apiUrl, data)
