...
export const downloadFj = (parma: any): Promise<Result> => {
  return baseService.exportGet(`sys/menuConfig/downloadFj?fileName=${parma.fileName}&uuid=${parma.uuid}`)
}
...
export const getConfigList = (params: any): Promise<Result> => {
  return baseService.get(`/ysStatDwConfig/getConfigList?nd=${params.nd}&busiType=${params.busiType}&parentId=${params.parentId}`)
}
...
export const copyStatConfig = (params: any): Promise<Result> => {
  return baseService.post(`/ysStatDwConfig/copyStatConfig?sourceNd=${params.sourceNd}&busiType=${params.busiType}&targetNd=${params.targetNd}`)
}

//结算率确认-获取临时表数据(statType:1.单位 2.项目类型)
export const getTempData = (params: any): Promise<Result> => {
  return baseService.get(`/ysjsltj/getTempData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
...
export const getImportTemplate = (params: any): Promise<Result> => {
  return baseService.exportGet(`/ysjsltj/getImportTemplate?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
//结算率确认-导入临时表数据(statType:1.单位 2.项目类型)
export const importTempData = (params: any): Promise<Result> => {
  return baseService.post(`/ysjsltj/importTempData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`, params.excelFormData)
}

//结算率确认-同步到正式表(statType:1.单位 2.项目类型)
export const syncToOfficial = (params: any): Promise<Result> => {
  return baseService.get(`/ysjsltj/syncToOfficial?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
//结算率确认-获取明细表数据(statType:1.单位 2.项目类型)
export const getDetailData = (params: any): Promise<Result> => {
  return baseService.get(`/ysjsltj/getDetailData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
...
export const getOfficialData = (params: any): Promise<Result> => {
  return baseService.get(`/ysjsltj/getOfficialData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}

//结算率确认-导出明细表数据(statType:1.单位 2.项目类型)
export const exportDetailData = (params: any): Promise<Result> => {
  return baseService.exportGet(`/ysjsltj/exportDetailData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}

//结算率确认-导出临时表数据(statType:1.单位 2.项目类型)
export const exportTempData = (params: any): Promise<Result> => {
  return baseService.exportGet(`/ysjsltj/exportTempData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
//结算率确认-导出正式表数据(statType:1.单位 2.项目类型)
export const exportOfficialData = (params: any): Promise<Result> => {
  return baseService.exportGet(`/ysjsltj/exportOfficialData?nd=${params.nd}&yd=${params.yd}&statType=${params.statType}`)
}
