export default class SystemController {
  static getKnowledgeList(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/app/knowledge/list', 'post', params, axiosOption, httpOption)
  }

  static getKnowledge(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/app/knowledge/view', 'get', params, axiosOption, httpOption)
  }

  static deleteKnowledge(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/app/knowledge/delete', 'post', params, axiosOption, httpOption)
  }

  static updateInfo(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/sysUser/updateInfo', 'post', params, axiosOption, httpOption)
  }

  static addKnowledge(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/app/knowledge/add', 'post', params, axiosOption, httpOption)
  }

  static updateKnowledge(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/app/knowledge/update', 'post', params, axiosOption, httpOption)
  }
  ...
  // 强退
  static forceLoginOut(sender, params, axiosOption, httpOption) {
    return sender.doUrl('admin/upms/login/forceLoginOut', 'post', params, axiosOption, httpOption)
  }
