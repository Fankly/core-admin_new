 ...
 * @returns
 */
export const getThemeConfigCacheByKey = (key: EThemeSetting, config?: IObject): string | boolean | number => {
 ...
 * @param value
 */
export const setThemeConfigToCache = (key: EThemeSetting, value: string | boolean | number): void => {
